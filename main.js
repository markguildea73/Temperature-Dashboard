...
function makeGraphs(error, data) {
    ...
    var parseDate = d3.time.format("%d/%m/%Y %H:%M").parse;
      ...
      var ndx = crossfilter(data);
        ...
        //used the example on the lesson but the function is not appropriate for this
...
//try three
    ...
    function makeGraphs(error, data) {
        ...
        //not appropriate for the file but will try
        function temperature_logger_data(date) {
            return function(d) {
                if (d.temp1 === "temp1" ) {
                    return +d.temp1;
                } if(d.temp2 === "temp2" ) {
